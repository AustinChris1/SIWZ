...
- `@siwz/core`: the protocol. SIWE-compatible classic message format *and* memo-challenge, ZIP 321 builder/parser, address parsing for `t1…` / `zs…` / `u1…`, pure-JS verification. 59 tests.
